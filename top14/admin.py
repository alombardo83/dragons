...
class MatchAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('season', 'round', 'date_time', 'played', ('team1', 'team2'), ('drops1', 'drops2'),
                       ('penalties1', 'penalties2'), ('tries1', 'tries2'), ('conversions1', 'conversions2'),
                       ('withdrawn_team1', 'withdrawn_team2')),
        }),
    )
